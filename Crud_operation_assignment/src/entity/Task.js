...
var Task = function () {
    ...
    var Task = _classThis = /** @class */ (function (_super) {
        ...
        function Task_1() {
            ...
            _this.priority = (__runInitializers(_this, _status_extraInitializers), __runInitializers(_this, _priority_initializers, void 0));
            _this.due_date = (__runInitializers(_this, _priority_extraInitializers), __runInitializers(_this, _due_date_initializers, void 0));
            _this.created_at = (__runInitializers(_this, _due_date_extraInitializers), __runInitializers(_this, _created_at_initializers, void 0));
            ...
            _this.user = (__runInitializers(_this, _updated_at_extraInitializers), __runInitializers(_this, _user_initializers, void 0));
    ...
    (function () {
        ...
        _due_date_decorators = [(0, typeorm_1.Column)({ type: 'date' })];
        _created_at_decorators = [(0, typeorm_1.Column)({ type: 'timestamp', default: function () { return 'CURRENT_TIMESTAMP'; } })];
        _updated_at_decorators = [(0, typeorm_1.Column)({ type: 'timestamp', default: function () { return 'CURRENT_TIMESTAMP'; }, onUpdate: 'CURRENT_TIMESTAMP' })];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return User_1.User; }, function (user) { return user.tasks; })];
